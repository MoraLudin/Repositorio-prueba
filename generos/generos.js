...
for (let index = 4; index < 8; index++) {
    console.log(generos[index].name);
    fila2.innerHTML += '<div class="buttongeneros1"> <a href="detail-genres.html?id='+generos[index].id+'"><h3> '+generos[index].name+'</h3> </div>'  
}
let fila3 = document.querySelector(".boxgenero3")
for (let index = 8; index < 12; index++) {
    console.log(generos[index].name);
    fila3.innerHTML += '<div class="buttongeneros1"> <a href="detail-genres.html?id='+generos[index].id+'"><h3> '+generos[index].name+'</h3> </div>'  
}
