...
for (let index = 0; index < 5; index++) {
    fila1.innerHTML += '<div class="rockgenero1"> <a href="../HTML/detail-artist.html?id='+bandas[index].id+'"><h2>'+bandas[index].name+'</h2></a> <img class="rock" src="'+bandas[index].picture_big+'" alt="'+bandas[index].name+'" ></div>'
...
for (let index = 5; index < 10; index++) {
    fila2.innerHTML += '<div class="rockgenero1"> <a href="../HTML/detail-artist.html?id='+bandas[index].id+'"><h2>'+bandas[index].name+'</h2></a> <img class="rock" src="'+bandas[index].picture_big+'" alt="'+bandas[index].name+'" ></div>'
